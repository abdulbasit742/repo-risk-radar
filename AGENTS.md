...
These instructions apply to the entire `abdulbasit742/repo-risk-radar` repository. More specific AGENTS.md or AGENTS.override.md files in subdirectories may refine them.

Project: **Repo Risk Radar**.
